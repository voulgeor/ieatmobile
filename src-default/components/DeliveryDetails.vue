...
export default {
  ...
  methods: {
    ...
    //   };
    //   this.loading = true;
    //   APIinterface.saveTransactionType($params)
    //     .then((data) => {
    //       APIinterface.setStorage(
    //         "transaction_type",
    //         this.transactionStore.transaction_type
    //       );
    //       this.transactionStore.new_transaction_type =
    //         this.transactionStore.transaction_type;
    //       this.$emit("afterSavetranstype", data.details);
    //       this.showModal(false);
    //     })
    //     .catch((error) => {
    //       this.showModal(false);
